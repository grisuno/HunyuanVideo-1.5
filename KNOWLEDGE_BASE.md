...
> Generated offline by **readmenator**. 38 files, 409 symbols, 293 imports. Supports C, C++, Python, Go, Rust, JS/TS, Java, C#, Shell, PHP, Dart, GDScript, Nim, ASM, Ruby, Swift, Kotlin, Scala, Lua, Elixir.
...
### hyvideo/pipelines (Cohesion: 0.74)
...
- `data_utils.py` (py, 3 symbols)
- `multitask_utils.py` (py, 2 symbols)
- `train.py` (py, 45 symbols)

### hyvideo/models/transformers/modules (Cohesion: 0.62)
...
### hyvideo/models/transformers/modules (Cohesion: 0.38)
...
- How are the 17 files in 'hyvideo/pipelines' related to each other?
...
graph TD
    ...
    subgraph community_2 ["hyvideo/models/transformers/modules"]
    ...
    subgraph community_3 ["hyvideo/utils/rewrite"]
