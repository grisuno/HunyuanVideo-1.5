...
### hyvideo/models/transformers/modules (Cohesion: 0.57)
...
- How are the 20 files in 'hyvideo/commons' related to each other?
...
graph TD
    ...
    subgraph community_0 ["hyvideo/commons"]
