...
### hyvideo/models/transformers/modules (Cohesion: 0.76)
...
### hyvideo/pipelines (Cohesion: 0.52)
...
graph TD
    ...
    subgraph community_2 ["hyvideo/pipelines"]
